...
namespace MiniProjectApp.Migrations
{
    ...
    [Migration("20240628180849_three")]
    partial class three
    {
            ...
            modelBuilder.Entity("MiniProjectApp.Models.Rent", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            BooksToBeReturned = 1,
                            CartType = "Rent Cart",
                            DateOfRent = new DateTime(2024, 6, 28, 23, 34, 48, 571, DateTimeKind.Local).AddTicks(3340),
                        ...
                        new
                        {
                            ...
                            BooksToBeReturned = 1,
                            CartType = "Super Cart",
                            DateOfRent = new DateTime(2024, 6, 28, 23, 34, 48, 571, DateTimeKind.Local).AddTicks(3360),
                            DueDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Progress = "Return pending",
                            UserId = 3
                        });
            ...
            modelBuilder.Entity("MiniProjectApp.Models.RentCart", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = 2,
                            BookId = 2,
                            DueDate = new DateTime(2024, 6, 28, 23, 36, 48, 571, DateTimeKind.Local).AddTicks(3567),
                            IsFined = 0,
            ...
            modelBuilder.Entity("MiniProjectApp.Models.RentDetail", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            BookId = 1,
                            Price = 5.0,
                            ReturnDate = new DateTime(2024, 6, 28, 23, 35, 48, 571, DateTimeKind.Local).AddTicks(3541),
                            status = "Returned"
                        },
                        new
                        {
                        ...
                        new
                        {
                            ...
                            BookId = 3,
                            Price = 0.0,
                            ReturnDate = new DateTime(2024, 6, 28, 23, 35, 48, 571, DateTimeKind.Local).AddTicks(3544),
                            status = "Returned"
                        },
                        new
                        {
            ...
            modelBuilder.Entity("MiniProjectApp.Models.SuperRentCart", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = 3,
                            BookId = 4,
                            DueDate = new DateTime(2024, 6, 28, 23, 36, 48, 571, DateTimeKind.Local).AddTicks(3580),
                            IsFined = 0,
                            RentDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            RentId = 2
                        });
