            ...
            modelBuilder.Entity("MiniProjectApp.Models.Rent", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            BooksToBeReturned = 1,
                            CartType = "Rent Cart",
                            DateOfRent = new DateTime(2024, 6, 28, 23, 30, 59, 249, DateTimeKind.Local).AddTicks(8523),
                        ...
                        new
                        {
                            ...
                            BooksToBeReturned = 1,
                            CartType = "Super Cart",
                            DateOfRent = new DateTime(2024, 6, 28, 23, 30, 59, 249, DateTimeKind.Local).AddTicks(8544),
                            DueDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Progress = "Return pending",
                            UserId = 3
                        });
            ...
            modelBuilder.Entity("MiniProjectApp.Models.RentCart", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = 2,
                            BookId = 2,
                            DueDate = new DateTime(2024, 6, 28, 23, 32, 59, 249, DateTimeKind.Local).AddTicks(8589),
                            IsFined = 0,
            ...
            modelBuilder.Entity("MiniProjectApp.Models.RentDetail", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            BookId = 1,
                            Price = 5.0,
                            ReturnDate = new DateTime(2024, 6, 28, 23, 31, 59, 249, DateTimeKind.Local).AddTicks(8570),
                            status = "Returned"
                        },
                        new
                        {
                        ...
                        new
                        {
                            ...
                            BookId = 3,
                            Price = 0.0,
                            ReturnDate = new DateTime(2024, 6, 28, 23, 31, 59, 249, DateTimeKind.Local).AddTicks(8572),
                            status = "Returned"
                        },
                        new
                        {
            ...
            modelBuilder.Entity("MiniProjectApp.Models.SuperRentCart", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = 3,
                            BookId = 4,
                            DueDate = new DateTime(2024, 6, 28, 23, 32, 59, 249, DateTimeKind.Local).AddTicks(8668),
                            IsFined = 0,
                            RentDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            RentId = 2
                        });
