...
namespace MiniProjectApp.Migrations
{
    ...
    [Migration("20240709015955_eight")]
    partial class eight
    {
            ...
            modelBuilder.Entity("MiniProjectApp.Models.Rent", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            BooksToBeReturned = 1,
                            CartType = "Rent Cart",
                            DateOfRent = new DateTime(2024, 7, 9, 7, 25, 54, 875, DateTimeKind.Local).AddTicks(8203),
                        ...
                        new
                        {
                            ...
                            BooksToBeReturned = 1,
                            CartType = "Super Cart",
                            DateOfRent = new DateTime(2024, 7, 9, 7, 25, 54, 875, DateTimeKind.Local).AddTicks(8253),
                            DueDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            Progress = "Return pending",
                            UserId = 3
                        });
            ...
            modelBuilder.Entity("MiniProjectApp.Models.RentCart", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = 2,
                            BookId = 2,
                            DueDate = new DateTime(2024, 7, 9, 7, 27, 54, 875, DateTimeKind.Local).AddTicks(8316),
                            IsFined = 0,
            ...
            modelBuilder.Entity("MiniProjectApp.Models.RentDetail", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            BookId = 1,
                            Price = 5.0,
                            ReturnDate = new DateTime(2024, 7, 9, 7, 26, 54, 875, DateTimeKind.Local).AddTicks(8298),
                            status = "Returned"
                        },
                        new
                        {
                        ...
                        new
                        {
                            ...
                            BookId = 3,
                            Price = 0.0,
                            ReturnDate = new DateTime(2024, 7, 9, 7, 26, 54, 875, DateTimeKind.Local).AddTicks(8300),
                            status = "Returned"
                        },
                        new
                        {
            ...
            modelBuilder.Entity("MiniProjectApp.Models.SuperRentCart", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = 3,
                            BookId = 4,
                            DueDate = new DateTime(2024, 7, 9, 7, 27, 54, 875, DateTimeKind.Local).AddTicks(8328),
                            IsFined = 0,
                            RentDate = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            RentId = 2
                        });
